...
namespace AnimeStudio.GUI
{
    partial class GameSelector : Form
    {
        ...
        static readonly List<GameType[]> HoyoGames = new List<GameType[]>
        {
            ...
            new[] { GameType.TOT },
            new[] { GameType.GGZ_117, GameType.GGZ_124 }, 
        };
        ...
        private void gameTypeCombo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    gameCombo.Items.AddRange(["Genshin Impact", "Honkai Impact 3rd", "Honkai: Star Rail", "Zenless Zone Zero", "Nexus Anima", "Tears of Themis", "Guns Girl Z"]);
                    break;
                case 1:
